...
ActiveRecord::Base.transaction do
  ...
  Apiv1::Appointment.create({"cancelled_at"=>nil, "company"=>"Seed Test Company", "company_permalink"=>"sd-tst-cmpn", "created_at"=>"2015-03-25T19:10:03.000Z", "deleted_at"=>nil, "expected_at"=>"2015-03-15T19:10:03.000Z", "exploded_at"=>nil, "fulfilled_at"=>nil, "id"=>65, "material_description"=>"400,000 pounds of HDPE N", "material_permalink"=>nil, "notes"=>"This appointment is a generated seed test", "permalink"=>"sd-tst-cmpn-65", "updated_at"=>"2015-04-04T00:05:27.000Z"})
  ...
  Apiv1::Appointment.create({"cancelled_at"=>nil, "company"=>"Seed Test Company", "company_permalink"=>"sd-tst-cmpn", "created_at"=>"2015-03-25T19:10:03.000Z", "deleted_at"=>nil, "expected_at"=>"2015-03-17T19:10:03.000Z", "exploded_at"=>nil, "fulfilled_at"=>nil, "id"=>67, "material_description"=>"-8 tons of dog food", "material_permalink"=>nil, "notes"=>"This appointment is a generated seed test", "permalink"=>"sd-tst-cmpn-67", "updated_at"=>"2015-04-03T01:01:53.000Z"})
  ...
  Apiv1::Appointment.create({"cancelled_at"=>nil, "company"=>"faderghqew", "company_permalink"=>"fdrghqw", "created_at"=>"2015-04-06T18:33:40.000Z", "deleted_at"=>nil, "expected_at"=>nil, "exploded_at"=>nil, "fulfilled_at"=>nil, "id"=>86, "material_description"=>"ggadsfga", "material_permalink"=>nil, "notes"=>"fasdag", "permalink"=>"fdrghqw-86", "updated_at"=>"2015-04-06T18:33:40.000Z"})

  Apiv1::Appointment.create({"cancelled_at"=>nil, "company"=>"Dog food Company", "company_permalink"=>"dg-fd-cmpn", "created_at"=>"2015-04-06T18:37:36.000Z", "deleted_at"=>nil, "expected_at"=>nil, "exploded_at"=>nil, "fulfilled_at"=>nil, "id"=>87, "material_description"=>"dog food", "material_permalink"=>nil, "notes"=>"fasda", "permalink"=>"dg-fd-cmpn-87", "updated_at"=>"2015-04-06T18:37:36.000Z"})

  Apiv1::Appointment.create({"cancelled_at"=>nil, "company"=>"death 2 jews", "company_permalink"=>"dth-2-jws", "created_at"=>"2015-04-06T19:45:19.000Z", "deleted_at"=>nil, "expected_at"=>nil, "exploded_at"=>nil, "fulfilled_at"=>nil, "id"=>88, "material_description"=>"nothing", "material_permalink"=>nil, "notes"=>"nothing to say", "permalink"=>"dth-2-jws-88", "updated_at"=>"2015-04-06T19:45:19.000Z"})

  Apiv1::Appointment.create({"cancelled_at"=>nil, "company"=>"f34yghregh", "company_permalink"=>"f34ghrgh", "created_at"=>"2015-04-06T19:49:59.000Z", "deleted_at"=>nil, "expected_at"=>nil, "exploded_at"=>nil, "fulfilled_at"=>nil, "id"=>89, "material_description"=>"fq3ghadfg", "material_permalink"=>nil, "notes"=>"agsgas", "permalink"=>"f34ghrgh-89", "updated_at"=>"2015-04-06T19:49:59.000Z"})

  Apiv1::Appointment.create({"cancelled_at"=>nil, "company"=>"3g5g3wh5", "company_permalink"=>"3g5g3wh5", "created_at"=>"2015-04-06T19:54:32.000Z", "deleted_at"=>nil, "expected_at"=>"2015-04-08T00:00:00.000Z", "exploded_at"=>nil, "fulfilled_at"=>nil, "id"=>90, "material_description"=>"rdfg", "material_permalink"=>nil, "notes"=>"fasdfa", "permalink"=>"3g5g3wh5-90", "updated_at"=>"2015-04-06T19:54:32.000Z"})

  Apiv1::Appointment.create({"cancelled_at"=>nil, "company"=>"Akino with Bless4", "company_permalink"=>"kn-wth-blss4", "created_at"=>"2015-04-07T18:46:05.000Z", "deleted_at"=>nil, "expected_at"=>"2015-04-07T00:00:00.000Z", "exploded_at"=>nil, "fulfilled_at"=>nil, "id"=>91, "material_description"=>"Jet Coaster Ride", "material_permalink"=>nil, "notes"=>"Testing appointment truck flow", "permalink"=>"kn-wth-blss4-91", "updated_at"=>"2015-04-07T18:46:05.000Z"})

  Apiv1::Appointment.create({"cancelled_at"=>nil, "company"=>"Whitest Kids U Known", "company_permalink"=>"whtst-kds-knwn", "created_at"=>"2015-04-07T18:47:55.000Z", "deleted_at"=>nil, "expected_at"=>"2015-04-08T00:00:00.000Z", "exploded_at"=>nil, "fulfilled_at"=>nil, "id"=>92, "material_description"=>"140 hours of trashy MA comedy", "material_permalink"=>nil, "notes"=>"Never appropriate for kids", "permalink"=>"whtst-kds-knwn-92", "updated_at"=>"2015-04-07T18:47:55.000Z"})

  Apiv1::Appointment.create({"cancelled_at"=>nil, "company"=>"Whitest Kids U Know", "company_permalink"=>"whtst-kds-knw", "created_at"=>"2015-04-14T00:41:20.000Z", "deleted_at"=>nil, "expected_at"=>nil, "exploded_at"=>nil, "fulfilled_at"=>nil, "id"=>93, "material_description"=>"Weird freaky racist humor", "material_permalink"=>nil, "notes"=>"nothing to say here", "permalink"=>"whtst-kds-knw-93", "updated_at"=>"2015-04-14T00:41:20.000Z"})

  Apiv1::Appointment.create({"cancelled_at"=>nil, "company"=>"Blackest Niggers U Know", "company_permalink"=>"blckst-nggrs-knw", "created_at"=>"2015-04-14T00:42:56.000Z", "deleted_at"=>nil, "expected_at"=>"2015-04-13T21:33:00.000Z", "exploded_at"=>nil, "fulfilled_at"=>nil, "id"=>94, "material_description"=>"racism and theft", "material_permalink"=>nil, "notes"=>"nothing", "permalink"=>"blckst-nggrs-knw-94", "updated_at"=>"2015-04-14T00:42:56.000Z"})

  Apiv1::Appointment.create({"cancelled_at"=>nil, "company"=>"Whatever Co", "company_permalink"=>"whtvr-c", "created_at"=>"2015-04-14T19:23:24.000Z", "deleted_at"=>nil, "expected_at"=>"2015-04-14T16:55:00.000Z", "exploded_at"=>nil, "fulfilled_at"=>nil, "id"=>95, "material_description"=>"Nothing", "material_permalink"=>nil, "notes"=>"afsdf", "permalink"=>"whtvr-c-95", "updated_at"=>"2015-04-14T19:23:24.000Z"})
